...
public class Server1 {
	...
	public Server1() {
		...
		MyDestinationFactory destFac = new MyDestinationFactory(enableProcess);
		svrFactory1.setDestinationFactory(destFac);
		
		svrFactory1.setServiceClass(Service.class);
		svrFactory1.setAddress("udp://192.168.56.1:9000/HelloWorld");
...
class MyDestinationFactory extends AbstractTransportFactory implements DestinationFactory {
    ...
    public MyDestinationFactory(boolean available) {
